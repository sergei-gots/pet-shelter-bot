...
public class AbstractMetaHandler extends Logged implements Handler {
    ...
    protected boolean handleCallbackQuery(Message message, String key) {
        return false;
    }

    protected boolean handleImg(Update update) {
        return false;
    }
